...
import br.com.mariodias.yuugen.search.database.BookDetails
...
class BookSearchAdapter(private val data: BookSearchResult) : Adapter<BookSearchAdapter.BookSearchViewHolder>() {
    ...
    inner class BookSearchViewHolder(private val item: ItemBookSearchBinding) : ViewHolder(item.root) {
        ...
        fun bind(bookSearchResultData: BookDetails) {
            ...
            Glide.with(this.itemView.context)
                .load(thumb)
                .error(Glide.with(this.itemView.context).load("https://voice.global/wp-content/plugins/wbb-publications/public/assets/img/placeholder.jpg"))
